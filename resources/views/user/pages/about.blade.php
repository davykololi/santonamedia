    ...
    <main role="main" class="container" id="main">
        <div class="row">
            <div class="col-sm-10 blog-main">
                <P style="color:red; font-family:PERPETUA TITLING MT;text-align:center"> SPECIALISTS IN WEB DESIGN AND DEVELOPMENT </P>
                <figure>                
                    <img width ="100px" height="100px" src= "{{asset('static/david.jpg')}}" alt="Dr.David Kololi"><br/>
