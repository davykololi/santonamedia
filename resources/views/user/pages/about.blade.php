...
@section('content')
    <main role="main" class="container" id="main">
        <div class="row">
            <div class="col-sm-12 blog-main" id="double" style="background-color: white;border-radius: 25px">
                <br/><br/>
                <h3 class="titles"> 
