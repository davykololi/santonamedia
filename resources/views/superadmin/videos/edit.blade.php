        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="titles"> EDIT A VIDEO</h3>
                    <a href="{!! route('videos.index') !!}" class="label label-primary pull-right">Back</a>
            </div>
            <div class="panel-body">
                <form action="{!! route('videos.update', $video->id) !!}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    @method('PUT')
