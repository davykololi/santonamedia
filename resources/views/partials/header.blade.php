            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <span style="font-family: Arial Black; font-size: 10px;" id="white">
                        {{ strtoupper(config('app.name', 'santonamedia')) }} <img width ="50px" height="50px" src= "{{asset('static/globe.png')}}" alt="{{ config('app.name', 'santonamedia') }}">
                    </span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                                <a id="whitecolor" class="navbar" href="{{route('categories',['slug' => $category->slug])}}">{{$category->name}}</a>
                        </li>
                                @endforeach
                        @endif  
                    </ul>
